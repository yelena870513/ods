angular.module('app.sao')
    .controller("generalController", function($scope, Manager, SAO, Util, $uibModal,Menu,$sce,SubMenu,$localStorage, Columns,$timeout,$location,SType) {
        ...
        // Manager.record('ministerio').then(function(data){$scope.ministerio = data.rows.map(function(m){return m.doc;})});
...
// $scope.alternativa = 'AlternativaHFC';
    ...
    .controller("modalController", function($scope, SAO, Manager, $uibModalInstance, record, general, Util, documents,action,$timeout) {
        ...
        $scope.ConsumoRecuperado = function(re3,amount){
            ...
            record.Recuperado = _.reject(record.Recuperado,function (el) { return el.anno==year;
            }).concat([{"re3":re3,"cant3":amount,"nombre": +re3+":"+amount}]);
        ...
        $scope.ConsumoTotal = function(re4,amount){
            ...
            record.Total = _.reject(record.Total,function (el) { return el.anno==year;
            }).concat([{"re4":re4,"cant4":amount,"nombre": +re4+":"+amount}]);
